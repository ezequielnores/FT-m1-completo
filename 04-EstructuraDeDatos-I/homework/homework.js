...
function nFibonacci(n) {
    if (ar[n] !== undefined) return ar[n]; //si en array[n] hay algo, devolvelo
        
        else{
            ar.push(ar[ar.length-1] + ar[ar.length - 2]) // añade al final la suma de 1 + 0
            return nFibonacci(n); //volve a iterar todo hsta que en arr[n] haya algun valor
        } 
}
